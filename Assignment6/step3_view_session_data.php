...
echo $twig->render('step3_view_session_data.twig', array('first_name' => $first_name, 'last_name' => $last_name, 'age' => $age, 'favorite_numbers' => $favorite_numbers/* your code here */ ));
